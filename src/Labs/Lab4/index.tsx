...
export default function Lab4() {
    ...
    return (
        <div id="wd-lab4" className="container-fluid">
            ...
            <h3>Lab 4: Managing State in Reach.js Applications</h3>
            <br />

            <h4 className="definition">Introduction:</h4>
            <ul>
                <li>In this assignment we are going to practice working with application and component level state</li>
                <li>We will be using the Redux state management library to handle application state, and use React.js state and effect hooks to manage component state.    </li>
