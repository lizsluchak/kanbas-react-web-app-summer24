export default function Lab4Introduction() {
    return (
        ...
        <div id="lab4-introduction">
            <h4 className="lab4-intro-definition">Lab 4 Introduction:</h4>
            <ul>
                ...
                <li><span className="lab4-intro-definition">State:</span> is the collection of data values stored in the various constants, variables and data structures in an application. </li>
                <ul>
                    <li><span className="lab4-intro-definition">Application State:</span> is data that is relevant across the entire application or a significant subset of related components. </li>
                    <ul>
                    ...
                    <li><span className="lab4-intro-definition">Component State:</span> is data that is only relevant to a specific component or a small set of related components. </li>
                    <ul>
