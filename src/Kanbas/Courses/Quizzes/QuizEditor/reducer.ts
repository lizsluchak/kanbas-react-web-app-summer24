...
const questionSlice = createSlice({
  name: "quizQuestion", //name the slice
  ...
  reducers: { //declare reducer functions
    ...
    */ 
    addQuizQuestion: (state, { payload: question }) => { //new module is in action payload
      ...
      state.quizQuestion = {...state.quizQuestion, newQuizQuestion} as any;
    },
...
export const { addQuizQuestion, setQuizQuestion } =
  questionSlice.actions; // export all reducer functions
export default questionSlice.reducer; //export reducer